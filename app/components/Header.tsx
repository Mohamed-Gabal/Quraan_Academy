  ...
  return (
    <header className="w-full border-b border-border/40">
      ...
      <div className="bg-primary text-white py-2"> 
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-3 text-[10px] sm:text-xs md:text-sm">
          
          {/* Contact Info */}
          <div className="flex items-center gap-4 sm:gap-6">
            <Link href="tel:+15551234567" className="flex items-center gap-2 hover:text-accent transition-all duration-300 group">
              <Image 
              ...
              />
              <span className="font-medium whitespace-nowrap">+1 (555) 123-4567</span>
            </Link>
            <div className="flex items-center gap-2 text-white/80">
              <Image src="/language_support.svg" alt="" width={15} height={15} />
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="flex items-center gap-3 border-r border-white/20 pr-4 sm:pr-5">
              {SOCIAL_LINKS.map((social) => (
                <Link key={social.name} href={social.href} className="transition-all duration-300 hover:scale-125">
                  <Image 
                    src={social.icon} 
                    alt={social.name} 
                    width={18} 
